 ...
 *
 * Está separada de `index.ts` (que es quien llama a listen) para que las pruebas
 * puedan montarla en memoria con supertest. Si el `listen` viviera aquí, importar
 * la app desde un test levantaría un servidor real y los tests pelearían por el
 * puerto 3000.
 */
